...
// HEADER
function Header({ telaAtiva = 'today', onNavegar }) {
  return (
        ...
        <div className="flex items-center justify-between h-14">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="font-black tracking-tight text-[--mike-fg] text-base hidden sm:block" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                TIPMIKE
              </span>
            </button>
