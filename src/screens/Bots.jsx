...
const MOCK_BOTS_BASE = [
  { id: 1, nome: 'Bot OFT Betano e-Soccer', casa: 'betano', estrategia: 'oft', esporte: 'e-Soccer',
    liga: 'Battle / GT League', status: 'rodando', conta: 'principal',
    favorito: true, automatizado: true, agendamento: 'Sex 18:00 → Dom 23:59',
    metricasBase: { entradas: 28, lucro: 32.40, roi: 28.9, wr: 68.4, dd: -8, stake: 4.0, sequencia: 3 },
    sparkline: [0, 5, 12, 18, 14, 22, 28, 35, 42, 38, 45, 52, 58, 62, 70],
    ultimasApostas: [
      { time: '14:32', sel: 'Over 1.5 HT', odd: 1.85, status: 'green', pl: +4.0 },
      { time: '14:18', sel: 'Over 0.5 HT', odd: 1.45, status: 'green', pl: +3.6 },
      { time: '14:02', sel: 'Over 1.5 HT', odd: 1.92, status: 'red', pl: -4.0 },
    ],
  },
  { id: 2, nome: 'Bot Under HT Betano Adriatic', casa: 'betano', estrategia: 'under_ht', esporte: 'e-Basket',
    liga: 'Adriatic NextGen', status: 'rodando', conta: 'principal',
    favorito: false, automatizado: true, agendamento: '24/7',
    metricasBase: { entradas: 12, lucro: 15.20, roi: 31.6, wr: 71.5, dd: -5, stake: 4.0, sequencia: 5 },
    sparkline: [0, 3, 6, 10, 14, 12, 18, 24, 28, 32, 36, 40, 38, 44, 48],
    ultimasApostas: [
      { time: '15:01', sel: 'Under 95.5', odd: 1.95, status: 'green', pl: +3.8 },
      { time: '14:45', sel: 'Under 102.5', odd: 1.78, status: 'green', pl: +3.1 },
    ],
  },
  { id: 3, nome: 'Bot Over FT Superbet Adriatic', casa: 'superbet', estrategia: 'over_ft', esporte: 'e-Basket',
    liga: 'Adriatic League', status: 'rodando', conta: 'principal',
    favorito: true, automatizado: true, agendamento: '24/7',
    metricasBase: { entradas: 35, lucro: 58.20, roi: 41.6, wr: 65.0, dd: -12, stake: 4.0, sequencia: -2 },
    sparkline: [0, 8, 15, 22, 30, 28, 36, 45, 52, 58, 65, 72, 78, 85, 92],
    ultimasApostas: [
      { time: '15:12', sel: 'Over 165.5', odd: 1.72, status: 'red', pl: -4.0 },
      { time: '14:58', sel: 'Over 158.5', odd: 1.85, status: 'red', pl: -4.0 },
      { time: '14:33', sel: 'Over 172.5', odd: 1.68, status: 'green', pl: +2.7 },
    ],
  },
  { id: 4, nome: 'Bot HC FT Live Arena Superbet', casa: 'superbet', estrategia: 'hc_ft', esporte: 'e-Soccer',
    liga: 'FIFA TM Live Arena', status: 'rodando', conta: 'principal',
    favorito: true, automatizado: true, agendamento: 'Seg-Sex 09:00 → 22:00',
    metricasBase: { entradas: 18, lucro: 13.30, roi: 18.4, wr: 63.0, dd: -3.5, stake: 4.0, sequencia: 2 },
    sparkline: [0, 2, 5, 8, 12, 15, 18, 22, 26, 30, 35, 40, 44, 48, 52],
    ultimasApostas: [{ time: '15:20', sel: 'HC -0.5 FAV', odd: 1.95, status: 'green', pl: +3.8 }],
  },
  { id: 5, nome: 'Bot OHT Bet365 e-Soccer', casa: 'bet365', estrategia: 'oht', esporte: 'e-Soccer',
    liga: 'Multi-ligas', status: 'pausado', conta: 'principal',
    favorito: false, automatizado: false, agendamento: null,
    metricasBase: { entradas: 0, lucro: 0, roi: 0, wr: 58.0, dd: -8, stake: 4.0, sequencia: 0 },
    sparkline: [0, 5, 8, 12, 10, 15, 18, 16, 22, 25, 28, 32, 30, 35, 38],
    ultimasApostas: [],
  },
  { id: 6, nome: 'Bot ML Estrelabet Battle', casa: 'estrelabet', estrategia: 'ml', esporte: 'e-Soccer',
    liga: 'Battle', status: 'rodando', conta: 'rotacao_1',
    favorito: false, automatizado: true, agendamento: '24/7',
    metricasBase: { entradas: 22, lucro: 16.80, roi: 19.1, wr: 61.5, dd: -7, stake: 4.0, sequencia: 1 },
    sparkline: [0, 3, 7, 12, 15, 18, 22, 25, 28, 32, 35, 38, 42, 45, 48],
    ultimasApostas: [{ time: '15:05', sel: 'Vitoria Casa', odd: 1.72, status: 'green', pl: +2.9 }],
  },
  { id: 7, nome: 'Bot HC H2H Estrelabet Valhalla', casa: 'estrelabet', estrategia: 'hc_h2h', esporte: 'e-Soccer',
    liga: 'Valhalla', status: 'parado', conta: 'rotacao_1',
    favorito: false, automatizado: false, agendamento: null,
    metricasBase: { entradas: 0, lucro: 0, roi: 0, wr: 52.0, dd: -10, stake: 4.0, sequencia: 0 },
    sparkline: [0, 2, 5, 3, 6, 8, 5, 10, 7, 12, 8, 5, 2, -2, -5],
    ultimasApostas: [],
  },
  { id: 8, nome: 'Bot O/U Novibet Multi-Liga', casa: 'novibet', estrategia: 'ou', esporte: 'e-Soccer',
    liga: 'Multi-ligas', status: 'agendado', conta: 'rotacao_2',
    favorito: false, automatizado: true, agendamento: 'Hoje 18:00',
    metricasBase: { entradas: 0, lucro: 0, roi: 0, wr: 58.5, dd: -5, stake: 4.0, sequencia: 0 },
    sparkline: [0, 4, 8, 12, 14, 18, 20, 22, 26, 28, 32, 30, 28, 32, 35],
    ultimasApostas: [],
  },
  { id: 9, nome: 'Bot OFT Vupi e-Basket', casa: 'vupi', estrategia: 'oft', esporte: 'e-Basket',
    liga: 'eBasket Battle', status: 'rodando', conta: 'principal',
    favorito: true, automatizado: true, agendamento: '24/7',
    metricasBase: { entradas: 16, lucro: 18.40, roi: 28.7, wr: 66.0, dd: -6, stake: 4.0, sequencia: 4 },
    sparkline: [0, 6, 12, 18, 22, 28, 35, 42, 48, 55, 60, 68, 72, 78, 85],
    ultimasApostas: [
      { time: '15:18', sel: 'Over HT 55.5', odd: 1.88, status: 'green', pl: +3.5 },
      { time: '15:02', sel: 'Over HT 62.5', odd: 1.92, status: 'green', pl: +3.7 },
    ],
  },
];
